...
namespace TextEditorSWF.ExtensionModel
{
	...
	/// <summary>Attribute which can be used to declare new commands</summary>
	public class CommandAttribute : CustomExtensionAttribute
	{
		...
		/// <summary>Resource that holds the command icon</summary>
		[NodeAttribute]
		public string IconResource { get; set; }

		/// <summary>File that holds the command icon</summary>
		[NodeAttribute]
		public string IconFile { get; set; }

		/// <summary>Label of the command</summary>
		[NodeAttribute]
